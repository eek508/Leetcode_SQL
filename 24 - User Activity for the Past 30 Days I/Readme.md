...
Note: **Any**  activity from (<code>'open_session'</code>, <code>'end_session'</code>, <code>'scroll_down'</code>, <code>'send_message'</code>) will be considered valid activity for a user to be considered active on a day.
